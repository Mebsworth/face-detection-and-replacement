function [ blendedFace ] = replace_face( faceA, replacementFaces, rX, rY, rHulls, rFeatures )
% REPLACE FACE
...
%% TPS Warp
[warpedFace, warpedMask] = warp_replacement_face(faceA, faceB, Bx, By, Ax, Ay, mask);
% figure;imshow(warpedFace);
% figure;imshow(warpedMask);
blendedFace = blend_faces(im2double(faceA),im2double(warpedFace),warpedMask);
