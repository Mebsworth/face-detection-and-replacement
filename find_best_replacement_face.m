...
minDiff = inf;
    ...
    for i = 1:6
        ...
        %% Homography
        % Set up params
        xDest = [ featuresA.leftEye.x, featuresA.rightEye.x, featuresA.nose.x,  featuresA.mouth.x];
        yDest = [ featuresA.leftEye.y, featuresA.rightEye.y, featuresA.nose.y, featuresA.mouth.y];
        xSource = [ featuresB.leftEye.x, featuresB.rightEye.x, featuresB.nose.x, featuresB.mouth.x];
        ySource = [ featuresB.leftEye.y, featuresB.rightEye.y, featuresB.nose.y, featuresB.mouth.y];
        % Find homography
